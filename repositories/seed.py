...
df = pd.read_csv('C:/Users/Whitegod Kingsley/Desktop/Reserved Area/Projects/flight-reservation/dataset/airlines.csv')  

# Step 2: Create a SQLAlchemy engine to connect to the MySQL database
engine = create_engine("mysql+mysqlconnector://root:z7fnvxQ2%40@localhost/flight")
...
df = pd.read_csv('C:/Users/Whitegod Kingsley/Desktop/Reserved Area/Projects/flight-reservation/dataset/airports.csv')
...
# Load the dataframe from the CSV file
flights_df = pd.read_csv('C:/Users/Whitegod Kingsley/Desktop/Reserved Area/Projects/flight-reservation/dataset/flights.csv')
